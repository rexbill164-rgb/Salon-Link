export const baseHead = (title: string, extra = '') => `
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .container{width:100%;max-width:1200px;margin:0 auto;padding:0 20px}@media(max-width:900px){body{font-size:14px;padding-bottom:100px}.container{padding:0 16px}.hide-mob{display:none!important}}@media(min-width:901px){.hide-desk{display:none!important}}
    .display-hero{font-size:clamp(32px,6vw,56px);font-weight:800;line-height:1.1}.display-xl{font-size:clamp(28px,4.5vw,44px);font-weight:700}.display-lg{font-size:clamp(22px,3.2vw,32px);font-weight:700}.display-md{font-size:clamp(18px,2.4vw,24px);font-weight:600}.display-sm{font-size:18px;font-weight:600}.font-display{font-family:'Poppins',sans-serif}.gold,.gold-gradient{color:var(--g-main)}.eyebrow{font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--g-main)}
    .card,.surface,.surface-raise,.surface-gold{background:var(--c-surface);border:1px solid var(--i-faint)}.card{border-radius:var(--r-xl);overflow:hidden}.btn-primary{display:inline-flex;align-items:center;justify-content:center;gap:8px;background:var(--g-main);color:#fff;font-size:13px;font-weight:700;border:none;border-radius:100px;padding:13px 28px;cursor:pointer;text-decoration:none}.btn-ghost,.btn-outline{display:inline-flex;align-items:center;justify-content:center;gap:8px;background:var(--i-ghost);color:var(--t-secondary);font-size:13px;font-weight:500;border:1px solid var(--i-faint);border-radius:100px;padding:11px 22px;cursor:pointer;text-decoration:none}.btn-icon{display:inline-flex;align-items:center;justify-content:center;width:44px;height:44px;background:var(--i-ghost);border:1px solid var(--i-faint);border-radius:50%;color:var(--t-secondary);cursor:pointer;text-decoration:none;flex-shrink:0}
    .input{width:100%;background:var(--c-raise);border:1.5px solid var(--i-faint);border-radius:var(--r-md);padding:14px 16px;color:var(--t-primary);font-family:'Poppins',sans-serif;font-size:14px;outline:none}.input-search{background:var(--c-raise);border:1.5px solid transparent;border-radius:100px;padding:14px 20px 14px 48px;font-size:14px;width:100%}.badge{display:inline-flex;align-items:center;gap:4px;padding:4px 10px;border-radius:100px;font-size:10px;font-weight:600;white-space:nowrap}.badge-verified{background:rgba(0,200,83,.10);color:var(--s-green);border:1px solid rgba(0,200,83,.20)}.badge-pending{background:rgba(255,149,0,.10);color:var(--s-amber);border:1px solid rgba(255,149,0,.20)}.badge-gold{background:var(--g-dim);color:var(--g-main);border:1px solid var(--g-border)}
    .nav-main{position:fixed;top:0;left:0;right:0;z-index:1000;background:rgba(255,255,255,.94);backdrop-filter:blur(28px);border-bottom:1px solid var(--i-faint)}.nav-link{color:var(--t-secondary);text-decoration:none;font-size:13px;font-weight:500;padding:8px 14px;border-radius:100px}.nav-link:hover,.nav-link.active{color:var(--g-main);background:var(--g-dim)}.mobile-nav{position:fixed;bottom:16px;left:50%;transform:translateX(-50%);width:calc(100% - 32px);max-width:420px;background:rgba(255,255,255,.96);border:1px solid rgba(255,255,255,.6);border-radius:28px;padding:8px;display:flex;justify-content:space-around;gap:4px;z-index:900;box-shadow:0 8px 40px rgba(0,0,0,.16)}.mobile-nav-item{flex:1;display:flex;flex-direction:column;align-items:center;gap:3px;padding:8px 4px;border-radius:20px;color:var(--t-muted);text-decoration:none;font-size:9px;font-weight:600}.mobile-nav-item.active{color:var(--g-main);background:var(--g-dim)}.mobile-nav-item.primary{background:var(--g-main);color:#fff;margin-top:-28px;width:64px;height:64px;flex:0 0 64px;border-radius:50%;justify-content:center}@media(min-width:901px){.mobile-nav{display:none}}
