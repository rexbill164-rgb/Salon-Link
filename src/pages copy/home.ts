  ...
  <div class="container">
    <div style="max-width:800px;margin:0 auto;text-align:center;">
      ...
      <div style="margin-top:40px;">
        <p class="stats-text">50,233 <span>appointments booked today</span></p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="footer-grid">
      <div>
        ...
        <p class="footer-desc">
          Ghana's leading beauty booking platform. Connecting clients with verified professionals since 2024.
        </p>
      </div>
      <div>
    ...
    <div class="footer-bottom">
      <p>© 2025 SalonLink. All rights reserved.</p>
